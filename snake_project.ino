    	...
    	Game(){
  		...
  		void restartGame(){
        	snake.direction = STOPPED;
          	...
          	snake.head.x = xSnake;      snake.head.y = ySnake;
          	apple.position.x = xApple;  apple.position.y = yApple; 	
  		...
  		void appleEaten(){
          	if(apple.position.x == snake.head.x
               && apple.position.y == snake.head.y){
            	snake.length++;
          	...
          	if(snake.direction != STOPPED){
            	...
            	int direction = snake.direction;
              	int x = snake.head.x, y = snake.head.y;
              	     ...
              	     if (direction == RIGHT)  snake.head.x = (x < 11) ? snake.head.x + 1 : 0;
              	else if (direction == LEFT)   snake.head.x = (x > 0) ?  snake.head.x - 1 : 11;
                else if (direction == BOTTOM) snake.head.y = (y < 6) ?  snake.head.y + 1 : 0;
              	else if (direction == TOP)    snake.head.y = (y > 0) ?  snake.head.y - 1 : 6;
